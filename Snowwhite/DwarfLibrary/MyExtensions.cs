...
namespace ExtensionMethods
{
    public static class MyExtensions
    {
        ...
        public static async Task ScrollToIndex(this ListViewBase listViewBase, int index)
        {
        ...
        public static async Task ScrollToItem(this ListViewBase listViewBase, object item)
        {
